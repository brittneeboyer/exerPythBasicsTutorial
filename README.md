...
* Complete the Learn the Basics section at: https://www.learnpython.org/
  ...
  * The Modules and Packages tutorial provides an example or urlopen() which is from Python 2. How would that function be called in Python 3? **urllib.request.urlopen()
  * In the Moduls and Packages tutorial, how should the example help(urllib.urlopen) be written? **help(urllib.request.urlopen)
